...
The domain contains strongly typed models representing lessons, exercises, and progress.
...
Progress is persisted using a simple JSON file backed by:
...
* JSON file creation
* Progress persistence across store instances
...
* [x] Define progress model
* [x] Implement simple progress storage
...
The immediate focus is to build the **Progression Engine and first usable practice UI**, while keeping the architecture simple and the lesson content completely data-driven.
